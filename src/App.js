...
import ReqMon from "./ReqMon";
import Requ from "./MakeReq";
function App() {
  return (
<div className="App">
   <Router>
    ...
    <Route exact path="/Main/reqMon"><Header page="reqMon"/><hr/><ReqMon/></Route>
    <Route path="/Main/makereq"><Header page="makereq"/><hr/><Requ/></Route>
